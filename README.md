...
For more [details](https://www.ibm.com/support/knowledgecenter/SSYHZ8_19.0.x/com.ibm.dba.bai/topics/con_bai_overview.html)

IBM Business Automation Insights allows you to capture all events that are generated by the operational systems that are implemented with the Digital Business Automation products, aggregate them into business-relevant KPIs, and present them in meaningful dashboards for lines of business to have a near real-time view on their business operations. 
