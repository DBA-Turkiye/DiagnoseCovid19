...
<!-- TOC -->autoauto- [Implementing COVID-19 Symptom Diagnosing by Using IBM Automation Solutions](#implementing-covid-19-symptom-diagnosing-by-using-ibm-automation-solutions)auto    - [Product Versions](#product-versions)auto    - [PreRequirements](#prerequirements)auto    - [Importing Projects](#importing-projects)auto- [ODM - Operational Decision Manager](#odm---operational-decision-manager)auto        - [ODM Decision Service Details](#odm-decision-service-details)auto- [BAW - Business Automation Workflow](#baw---business-automation-workflow)auto    - [Execute DB Scripts](#execute-db-scripts)auto    - [Import Process Application](#import-process-application)auto        - [Starting the Process from Process Portal](#starting-the-process-from-process-portal)auto- [Business Automation Insights](#business-automation-insights)autoauto<!-- /TOC -->
