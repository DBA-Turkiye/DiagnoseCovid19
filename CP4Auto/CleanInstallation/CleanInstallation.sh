...
#If the Kafka pods are not working
Go to /data/persistentvolumes/kafka on NFS
delete log files under ibm-bai-pv,1,2
...
# Modify icp4adeploy-default-deny as below
spec:
  podSelector: {}
  #add ingress
  ingress:
...
#for business performance center: follow steps: https://www.ibm.com/support/knowledgecenter/SSYHZ8_20.0.x/com.ibm.dba.bai/topics/tsk_bai_top_cred_secrets.html
